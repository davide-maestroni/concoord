...
public class Iter<T> implements Task<T> {
  ...
  private static class IterAwaitable<T> implements Awaitable<T> {

    private final Logger forLogger = new Logger(Awaitable.class, this);
    private final CircularQueue<IterFlowControl> flowControls = new CircularQueue<IterFlowControl>();
    private final Scheduler scheduler;
    private final Iterator<? extends T> iterator;
    private IterFlowControl currentFlowControl;
    ...
    public void await(int maxEvents, @NotNull Awaiter<? super T> awaiter) {
      ...
      scheduler.scheduleLow(new IterFlowControl(maxEvents, awaiter));
    }
    ...
    private class IterFlowControl implements FlowControl<T>, Runnable {
      ...
      private IterFlowControl(int maxEvents, @NotNull Awaiter<? super T> awaiter) {
      ...
      private class InitState implements Runnable {
        ...
        public void run() {
          final IterFlowControl thisFlowControl = IterFlowControl.this;
          if (currentFlowControl == null) {
